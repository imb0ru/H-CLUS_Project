...
public class HierachicalClusterMiner {
	 ...
	 */
	public void mine(Data data, ClusterDistance distance) throws InvalidDepthException, InvalidClustersNumberException, InvalidSizeException, CloneNotSupportedException {
